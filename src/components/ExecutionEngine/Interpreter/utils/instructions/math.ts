...
export function runIadd(thread: NativeThread) {
...
export function runLadd(thread: NativeThread) {
  const value2 = thread.popStack();
  const value1 = thread.popStack();
  thread.pushStack64(BigInt.asIntN(64, value1 + value2));
}

export function runFadd(thread: NativeThread) {
...
export function runLsub(thread: NativeThread) {
  const value2: bigint = thread.popStack();
  const value1: bigint = thread.popStack();
  thread.pushStack64(BigInt.asIntN(64, value1 - value2));
}

export function runFsub(thread: NativeThread) {
  const value2 = asFloat(thread.popStack());
  const value1 = asFloat(thread.popStack());
...
export function runDsub(thread: NativeThread) {
  const value2 = asDouble(thread.popStack64());
  const value1 = asDouble(thread.popStack64());
  thread.pushStack64(value1 - value2);
}

export function runImul(thread: NativeThread) {
  const value2 = thread.popStack();
  const value1 = thread.popStack();
  thread.pushStack(Math.imul(value1, value2) | 0);
}

export function runLmul(thread: NativeThread) {
  const value2: bigint = thread.popStack64();
  const value1: bigint = thread.popStack64();
  thread.pushStack64(BigInt.asIntN(64, value1 * value2));
}

export function runFmul(thread: NativeThread) {
  const value2 = asFloat(thread.popStack());
  const value1 = asFloat(thread.popStack());
  thread.pushStack(asFloat(value1 * value2));
}

export function runDmul(thread: NativeThread) {
  const value2 = asDouble(thread.popStack64());
  const value1 = asDouble(thread.popStack64());
  thread.pushStack64(value1 * value2);
}

export function runIdiv(thread: NativeThread) {
  const value2 = thread.popStack();
  const value1 = thread.popStack();
...
export function runLdiv(thread: NativeThread) {
  const value2: bigint = thread.popStack64();
  const value1: bigint = thread.popStack64();
...
export function runFdiv(thread: NativeThread) {
  const value2 = asFloat(thread.popStack());
  const value1 = asFloat(thread.popStack());
  thread.pushStack(asFloat(value1 / value2));
}

export function runDdiv(thread: NativeThread) {
  const value2 = asDouble(thread.popStack64());
  const value1 = asDouble(thread.popStack64());
  thread.pushStack64(value1 / value2);
}

export function runIrem(thread: NativeThread) {
  const value2 = thread.popStack();
  const value1 = thread.popStack();
...
export function runLrem(thread: NativeThread) {
  const value2: bigint = thread.popStack64();
  const value1: bigint = thread.popStack64();
...
export function runFrem(thread: NativeThread) {
  const value2 = asFloat(thread.popStack());
  const value1 = asFloat(thread.popStack());
  thread.pushStack(asFloat(value1 % value2));
}

export function runDrem(thread: NativeThread) {
  const value2 = asDouble(thread.popStack64());
  const value1 = asDouble(thread.popStack64());
  thread.pushStack64(value1 % value2);
}

export function runIneg(thread: NativeThread) {
  const value = thread.popStack();
  thread.pushStack(-value | 0);
}

export function runLneg(thread: NativeThread) {
  const value: bigint = thread.popStack64();
  thread.pushStack64(BigInt.asIntN(64, -value));
}

export function runFneg(thread: NativeThread) {
  const value = asFloat(thread.popStack());
  thread.pushStack(asFloat(-value));
}

export function runDneg(thread: NativeThread) {
  const value = asDouble(thread.popStack64());
  thread.pushStack64(-value);
}

export function runIshl(thread: NativeThread) {
  const value2 = thread.popStack();
  const value1 = thread.popStack();
  thread.pushStack((value1 << (value2 & 0x1f)) | 0);
}

export function runLshl(thread: NativeThread) {
  const value2: number = thread.popStack();
  const value1: bigint = thread.popStack64();
  thread.pushStack64(BigInt.asIntN(64, value1 << BigInt(value2 & 0x3f)));
}

export function runIshr(thread: NativeThread) {
  const value2 = thread.popStack();
  const value1 = thread.popStack();
  thread.pushStack((value1 >> (value2 & 0x1f)) | 0);
}

export function runLshr(thread: NativeThread) {
  const value2: number = thread.popStack();
  const value1: bigint = thread.popStack64();
  thread.pushStack64(BigInt.asIntN(64, value1 >> BigInt(value2 & 0x3f)));
}

export function runIushr(thread: NativeThread) {
...
export function runLushr(thread: NativeThread) {
...
export function runIand(thread: NativeThread) {
  const value2 = thread.popStack();
  const value1 = thread.popStack();
  thread.pushStack((value1 & value2) | 0);
}

export function runLand(thread: NativeThread) {
  const value2: bigint = thread.popStack64();
  const value1: bigint = thread.popStack64();
  thread.pushStack64(BigInt.asIntN(64, value1 & value2));
}

export function runIor(thread: NativeThread) {
  const value2 = thread.popStack();
  const value1 = thread.popStack();
  thread.pushStack(value1 | value2 | 0);
}

export function runLor(thread: NativeThread) {
  const value2: bigint = thread.popStack64();
  const value1: bigint = thread.popStack64();
  thread.pushStack64(BigInt.asIntN(64, value1 | value2));
}

export function runIxor(thread: NativeThread) {
  const value2 = thread.popStack();
  const value1 = thread.popStack();
  thread.pushStack((value1 ^ value2) | 0);
}

export function runLxor(thread: NativeThread) {
  const value2: bigint = thread.popStack64();
  const value1: bigint = thread.popStack64();
  thread.pushStack64(BigInt.asIntN(64, value1 ^ value2));
}

export function runIinc(thread: NativeThread) {
